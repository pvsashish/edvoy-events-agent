...
**Last updated:** 2026-07-08 (Scout self-serve in-product uploader — `ScoutUploadModal`) · earlier: 2026-07-03 (Mobile/tablet responsive fixes incl. a global `<aside>` CSS bug; Space switcher incl. Scout scoping + sheet-edit-box fix; History thumbnails on Cloudflare R2 + auto-migration; Scout images on Cloudflare R2; dedicated Neon project; Postgres pool crash fix)
